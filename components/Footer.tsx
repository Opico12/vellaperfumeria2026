        ...
        <footer className="bg-black border-t border-gray-800 text-white font-sans">
            <div className="container mx-auto px-6 py-16">
                <div className="flex flex-col items-center text-center">
                    <h2 className="text-3xl font-black uppercase tracking-[0.3em] text-white mb-4 italic">Bella <span className="text-[#E29CD2]">Perfumería</span></h2>
                    ...
                    <div className="w-full border-t border-white/5 pt-8">
                        <ul className="flex flex-wrap justify-center gap-12 text-[10px] font-black uppercase tracking-widest text-gray-500">
                            <li><button onClick={() => window.location.href = HOME_URL} className="hover:text-white transition-colors">Inicio</button></li>
