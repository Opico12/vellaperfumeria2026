...
const OfertasPage: React.FC<{
    ...
    return (
        <div className="container mx-auto px-4 md:px-12 pb-20">
            {/* BANNER AZUL NOCHE CON PUNTITAS DORADAS */}
            <div className="relative w-full h-[450px] md:h-[600px] rounded-sm overflow-hidden mb-24 flex items-center justify-center text-center shadow-3xl bg-[#050a18]">
                {/* Fondo de estrellas/puntos dorados - Galaxia de Oro */}
                ...
                <div className="relative z-10 px-6 max-w-4xl">
                    ...
                    <p className="text-white/80 text-lg md:text-2xl font-light italic mb-12 tracking-widest uppercase max-w-2xl mx-auto leading-relaxed">
                        Brilla con los cosméticos más deseados de Vellaperfumería.
                    </p>
                    <div className="flex justify-center gap-6 items-center">
                        <div className="h-[1px] w-12 md:w-24 bg-yellow-500/50"></div>
                        <span className="text-yellow-500 text-[11px] font-black tracking-[0.6em] uppercase">Hasta -60% OFF Real</span>
                        <div className="h-[1px] w-12 md:w-24 bg-yellow-500/50"></div>
                    </div>
                </div>
                ...
                <style>{`
                    .bg-[#050a18] {
                        background: radial-gradient(circle at center, #0a1944 0%, #040816 100%);
                    }
                    .night-sky {
                        position: absolute;
                        width: 100%;
                    ...
                    .gold-sparks {
                        ...
                        height: 100%;
                        background-image: 
                            radial-gradient(2px 2px at 10% 30%, #facc15, transparent),
                            radial-gradient(2.5px 2.5px at 50% 10%, #facc15, transparent),
                            radial-gradient(1.5px 1.5px at 80% 60%, #facc15, transparent);
                    ...
                    <section key={section.id} id={section.id} className="animate-fade-in">
                        <div className="flex flex-col md:flex-row md:items-end gap-6 mb-16">
                             <div className="text-left">
                                 <span className="text-pink-600 text-[10px] font-black tracking-[0.6em] uppercase mb-4 block underline underline-offset-8 decoration-black">Favoritos del Público</span>
